...
def test_downside_control_zero_teacher_positive_decoded_uses_floor() -> None:
    assert (
        compute_downside_control(
            decoded_drawdown=1.0,
            dp_drawdown=0.0,
...
def test_downside_control_uses_floor_when_teacher_drawdown_is_tiny() -> None:
    assert (
        compute_downside_control(
            decoded_drawdown=0.75,
            dp_drawdown=0.01,
            denominator_floor=1.0,
        )
        == 0.75
