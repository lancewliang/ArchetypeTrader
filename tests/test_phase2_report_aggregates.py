...
def test_phase2_evaluator_report_payload_includes_pair_profitability_matrix() -> None:
    ...
    payload = evaluator._build_report_payload(
        selector_returns=np.asarray([1.0, 2.0, -1.0, 3.0]),
    ...
    assert payload["selector_pair_profitability_matrix"]
    assert payload["code_diagnostics"]
